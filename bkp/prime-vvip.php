...
<?php include 'includes/header.php';?>
    ...
    <!-- pricing primevvip package section -->

    <section class="pricing_primevvip_package_section">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <img
              class="newimageforex_section"
              src="./images/forexnewimagedownload.jpg"
              alt="image"
            />
          </div>
        </div>
        <br />
        <!-- three-cards-modification -->
        <div class="row">
          <div class="col-lg-4">
