...
<!-- Banner Start-->
  <section class="banner_dm">
    <div class="container">
      <div class="row">
        <div class="col-md-12 crm_banner_image">
          <img src="<?=base_url()?>public/web/images/digital-desktop.png" width="60%">
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <div class="cta_unique">
            <a class="dm_anchor unique_anchor" href="contact_us">Get in Touch </a>
          </div>
        </div>
      </div>
    </div>
...
<!-- Cards Section Satart-->

<section class="why_dm">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h4 class="dm_cards_h4 text-center">
            Why?
          </h4>
          <h3 class="dm_cards_sub_heading text-center">Why digital marketing</h3>
      </div>
    </div>
    <div class="row dm_row_two">
      <div class="col-md-4">
        <div class="dm_image_box">
          <img src="<?=base_url()?>public/web/images/bitcoin.png" class="dm_box_image">
...
<section class="dm_tilt_sec">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h2 class="dm_cards_h2 text-center">Our Social Media Marketing approach</h2>
      </div>
    </div>
    <div class="row dm_row_two">
      <div class="col-md-3">
        <div class="image_box_dm">
          <img src="<?=base_url()?>public/web/images/facebook.png" class="image_box_dm_images">
      ...
      <div class="col-md-3">
        <div class="image_box_dm">
          <img src="<?=base_url()?>public/web/images/instagram.png" class="image_box_dm_images">
          <div class="image_box_dm_content">
            <h4>Instagram</h4>
      ...
      <div class="col-md-3">
        <div class="image_box_dm">
          <img src="<?=base_url()?>public/web/images/tweet.png" class="image_box_dm_images">
          <div class="image_box_dm_content">
            <h4>Twitter</h4>
      ...
      <div class="col-md-3">
        <div class="image_box_dm">
          <img src="<?=base_url()?>public/web/images/linkedin.png" class="image_box_dm_images">
          <div class="image_box_dm_content">
            <h4>LinkedIn</h4>
    ...
    <div class="row dm_row_three">
      <div class="col-md-12">
        ...
        <h2 class="dm_cards_h2 text-center">Our Search Engine Optimization approach</h2>
      </div>
    </div>
    <div class="row dm_row_three">
      <div class="col-md-6">
        <div class="seo_image_box">
          <img src="<?=base_url()?>public/web/images/asterisk-1.png" class="seo_image_sec">
  ...
  <div class="container blog_conatainer">
    <div class="dm_blogs-heading">
      <span>Blog</span>
      <h2>Our blog</h2>
    </div>
