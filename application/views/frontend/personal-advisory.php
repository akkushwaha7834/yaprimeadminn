  ...
  <!-- HEADER -->
  <!-- Banner Start-->
  <section class="prime_ad_banner">
    <div class="container-fluid prime_banner_container">
      <div class="row">
        <div class="col-md-3 mobile_images">
          <img src="<?=base_url()?>public/web/images/eth-l.png" class="prime_banner_images" width="">
          <img src="<?=base_url()?>public/web/images/usdt-l.png" class="prime_banner_images" width="">
          <img src="<?=base_url()?>public/web/images/bnb-l.png" class="prime_banner_images" width="">
          <img src="<?=base_url()?>public/web/images/btc-l.png" class="prime_banner_images" width="">
        </div>
        <div class="col-md-6">
          <h4 class="mt4_h4">
            Personal Advisory
        ...
        <div class="col-md-3 mob_right">
          <img src="<?=base_url()?>public/web/images/eth-r.png" class="prime_banner_images_right" width="">
          <img src="<?=base_url()?>public/web/images/usdt-r.png" class="prime_banner_images_right" width="">
          <img src="<?=base_url()?>public/web/images/bnb-r.png" class="prime_banner_images_right" width="">
          <img src="<?=base_url()?>public/web/images/btc-r.png" class="prime_banner_images_right" width="">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="benefits_sec">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <img src="<?=base_url()?>public/web/images/aapl.png" width="100%">
        </div>
      </div>

      <div class="row aapl_row_two">
        <div class="col-md-6">
          <img src="<?=base_url()?>public/web/images/aapl_one.png" width="100%">
        </div>
        <div class="col-md-6 benefits_left">
          <h2 class="benefits_h2">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="row row_check_white">
          <div class="col-md-6 pricing_col_6_first">
            <img src="<?=base_url()?>public/web/images/images_11.png" style="float: left;">
            <br>
            <br>
          ...
          <div class="col-md-6 pricing_col_6_second">
            <img src="<?=base_url()?>public/web/images/image_22.png" style="float: left;"><br><br>
            <h2 class="head_pricing">
        ...
        <div class="row row_check_white">
          <div class="col-md-6 pricing_col_6_third">
            <img src="<?=base_url()?>public/web/images/image_33.png" style="float: left;">
            <br>
            <br>
            <h2 class="head_pricing">
            Transparency
          ...
          <div class="col-md-6 pricing_col_6_fourth">
            <img src="<?=base_url()?>public/web/images/image_44.png" style="float: left;">
            <br>
            <br>
            <h2 class="head_pricing">
            Continuous Support
