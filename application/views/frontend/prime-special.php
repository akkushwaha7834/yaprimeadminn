  ...
  <body>
    ...
    <section class="prime_special-section">
      <div class="container">
        <div class="row postioning">
          <div class="col-lg-6 prime_vip_section">
            ...
            <div class="demo_contact">
              ...
              <a href="contact_us" class="contact_sales_special">Contact Sales</a>
            </div>
          </div>

          <div class="col-lg-5 image_section">
            <div class="inner_image_section">
                <img src="<?=base_url()?>public/web/images/primespecialposter.png" alt="frame11" width="100%" />
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- benefits of prime special package -->
    <section>
      <div class="container prime_special_section">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimage1.svg" alt="service1 image" />
          ...
          <div class="col-lg-4">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimage2.svg" alt="service1 image" />
                <span class="take_control_heading"
          ...
          <div class="col-lg-4">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimage3.svg" alt="service1 image" />
                <span class="take_control_heading"
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimage4.svg" alt="service1 image" />
                <span class="take_control_heading"
          ...
          <div class="col-lg-4">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimage5.svg" alt="service1 image" />
                <span class="take_control_heading"
          ...
          <div class="col-lg-4">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimage6.svg" alt="service1 image" />
                <span class="take_control_heading"
    ...
    <!-- hero banner prime special package -->
    <section class="herobannerSection_prime-special">
      <div class="container">
        <div class="row postiondiv">
          <div class="col-lg-5 brokerage_section">
            ...
            <a href="start_broker" class="get_started_button">Get Started</a>
          </div>
          <div class="col-lg-5">
            <img class="prime_special_image" src="<?=base_url()?>public/web/images/herobanner_primespecialimg.png" alt="herobanner image" width="100%" />
          </div>
        </div>
      </div>
    </section>

    <!-- hero banner prime signal section_2 -->
    <section class="hero_banner_vvip_section2">
      <div class="container">
        <div class="row rowcoloring_vvip">
          <div class="col-lg-6 positiongvvip">
            ...
            <br />
            <a href="start_broker" class="get_started_vvip_button">Get Started</a>
          </div>

          <div class="col-lg-6">
            <img
              class="vvipsecimgage_section"
              src="<?=base_url()?>public/web/images/vvipsec.png"
              alt="image"
              \
            />
          </div>
    ...
    <!-- prime special feature section -->
    <section class="prime_special_feature_section">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimg7.svg" alt="service1 image" />
                <span class="take_control_heading"
            ...
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimg8.svg" alt="service1 image" />
                <span class="take_control_heading"
          ...
          <div class="col-lg-6">
            <img
              class="special_section_image"
              src="<?=base_url()?>public/web/images/specialsectionimage1.png"
              alt=""
            />
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">
            <img
              class="special_section_image"
              src="<?=base_url()?>public/web/images/specialsectionimage2.png"
              alt=""
            />
          </div>
          <div class="col-lg-6">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="<?=base_url()?>public/web/images/vvipimg9.svg" alt="service1 image" />
                <span class="take_control_heading"
...
?>
  ...
  <!-- faq section with accordian -->
    ...
    <section class="pricing_plan_section">
      <div class="container">
        <center><div class="heading">Comparison</div></center>
        <div class="package_plans">Compare YaPrime plan packages</div>
        <div class="package_discription">
          We have solid experience of working with Tier-1 liquidity providers
          and our effectiveness has stood the test of time, proven by
      ...
      <div class="container">
        <table class="table table-striped table-responsive">
          <thead>
            <tr>
              ...
              <th class="th_css" scope="col">Prime VIP</th>
              <th class="th_css" scope="col">Prime VVIP</th>
              <th class="th_css" scope="col">Prime Special</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <th class="th_css" scope="row">Single margin account model</th>
              <td>
            ...
            <tr>
              <th class="th_css" scope="row">Simple risk management system</th>
              <td>
                <i class="fa fa-check greentick" aria-hidden="true"></i>
              </td>
              <td>
            ...
            <tr>
              <th class="th_css" scope="row">Multiple types of liquidity</th>
              <td>
                <i class="fa fa-check greentick" aria-hidden="true"></i>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <i class="fa fa-times redtick" aria-hidden="true"></i>
              </td>
              <td>
                <i class="fa fa-check greentick" aria-hidden="true"></i>
              </td>
        ...
        <!-- TALK TO US -->
    <?php include 'includes/talk_to_us.php';?>
