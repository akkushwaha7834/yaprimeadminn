  ...
  <?php include 'includes/header.php';?>
        ...
        <div class="row postioning">
          ...
          <div class="col-lg-6 image_section">
            <div class="inner_image_section">
                <img src="<?=base_url()?>public/web/images/creditcard.png" alt="frame11" width="100%" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="Benefits_section prime_Benefits_section">
      <div class="container">
        <div class="row">
        ...
        <div class="row">
              ...
              <div class="ready_made">
                <img src="<?=base_url()?>public/web/images/primevipimage1.png" />
      ...
      <br>
              <div class="ready_made">
                <img src="<?=base_url()?>public/web/images/primevipimage2.png" />
            ...
            <div class="col-lg-6 feature_first">
              <div class="ready_made">
                <img src="<?=base_url()?>public/web/images/primevipimage3.png" />
   ...
   <br>
              <div class="ready_made">
                <img src="<?=base_url()?>public/web/images/primevipimage4.png" />
...
<div class="container">
        ...
        <div class="row position_rows">
          ...
          <div class="col-lg-6 yasection">
            <div class="yalogo_section">
              <img src="<?=base_url()?>public/web/images/yaprimecircle.png" />
            </div>
            <div class="yaPara">
        ...
        <section class="pricing_plan_section">
          <div class="container">
            ...
            <div class="package_discription">
              We have solid experience of working with Tier-1 liquidity
              providers and our effectiveness has stood the test of time, proven
              by multi-billion dollar turnovers.
            </div>
          </div>
          <!-- pricing table -->
          <div class="container">
