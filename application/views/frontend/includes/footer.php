      ...
      <div class="row">
        ...
        <div class="col-md-3 col-width">
          ...
          <ul>
            ...
            <a href="<?=base_url()?>liquidity-solution">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="copyrights">
            <p>All Rights Reserved © 2016-2023 |<a href="index"> YaPrime</a></p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="copyrights">
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-6 pop_up_form_class">
                        <form method="POST" action="<?= base_url('admin/request_demo/request_demo_submit_data'); ?>" enctype="multipart/form-data"class="row g-2 needs-validation form-style" novalidate>
