<body>
  ...
  <section class="graphic_design_banner_section">
    <div class="container">
        ...
        <div class="col-lg-6 prime_vip_section_carousal">
          ...
          <div class="demo_contact">
            <div class="request_demo">
              <a class="nav-link coloring_header" href="contact_us"> Get In Touch</a>
            </div>
          </div>
        </div>
        <div class="col-lg-6 image_section_carousal">
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="<?=base_url()?>public/web/images/graphicdesignherobanner.png" alt="First slide" />
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="<?=base_url()?>public/web/images/graphicdesignherobanner.png" alt="Second slide" />
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="<?=base_url()?>public/web/images/graphicdesignherobanner.png" alt="Third slide" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row uiuxmain_banner_technology">
        <div class="col-lg-12">
          <center>
            <div class="technologies_uiux">Technologies we work on</div>
            <div class="app_design_position">
              <img src="<?=base_url()?>public/web/images/webdevicons.png" alt="appicons" width="100%" />
            </div>
          </center>
        </div>
      </div>
  ...
  <section class="uiuxFeatureSection">
    <div class="container">
      <div class="uiuxHeading">Graphic Design</div>
      <div class="row">
        <div class="col-lg-4">
          <div class="card card_modification2">
            <div class="takecontrol_section">
              <img src="<?=base_url()?>public/web/images/graphicimgg1.svg" alt="service1 image" />
        ...
        <div class="col-lg-4">
          <div class="card card_modification2">
            <div class="takecontrol_section">
              <img src="<?=base_url()?>public/web/images/graphicimgg2.svg" alt="service1 image" />
        ...
        <div class="col-lg-4">
          <div class="card card_modification2">
            <div class="takecontrol_section">
              <img src="<?=base_url()?>public/web/images/graphicimgg3.svg" alt="service1 image" />
      ...
      <div class="row video_row_two">
        <div class="col-lg-4">
          <div class="card card_modification2">
            <div class="takecontrol_section">
              <img src="<?=base_url()?>public/web/images/graphicimgg4.svg" alt="service1 image" />
        ...
        <div class="col-lg-4">
          <div class="card card_modification2">
            <div class="takecontrol_section">
              <img src="<?=base_url()?>public/web/images/graphicimgg5.svg" alt="service1 image" />
        ...
        <div class="col-lg-4">
          <div class="card card_modification2">
            <div class="takecontrol_section">
              <img src="<?=base_url()?>public/web/images/graphicimgg6.svg" alt="service1 image" />
  ...
  <!-- ui_ux Case Study -->
  <section class="casestudysection_uiUx">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="caseStudy_heading">Case studies</div>
          <br />
          <div class="caseStudy_information">Check out our work</div>
          <br />
          <br />
        </div>
      </div>
        ...
        <div class="col-lg-12">
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner custom-display-slider">
              <div class="carousel-item active">
                <img class="d-block" src="<?=base_url()?>public/web/images/casestudyimage.png" alt="First slide" />
                <br />
                <div class="case_study_carousal_heading">
                  YaMarket stock app
                </div>
                <br />
                <div class="case_study_carousal_desciption">
                  The YaMarkets stocks app aids in monitoring and managing
                  your stock portfolio.
                </div>
              </div>
              <div class="carousel-item">
                <img class="d-block" src="<?=base_url()?>public/web/images/casestudyimage2.png" alt="Second slide" />
                <br />
                <div class="case_study_carousal_heading">
                  YaMarket stock app
                </div>
              ...
              <div class="carousel-item">
                <img class="d-block" src="<?=base_url()?>public/web/images/casestudyimage.png" alt="Third slide" />
                <br />
                <div class="case_study_carousal_heading">
                  YaMarket stock app
                </div>
