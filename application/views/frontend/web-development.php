  ...
  <body>
    ...
    <!-- web development hero banner section -->
    <section class="Hero_banner_vvip_section_webdev">
      <div class="container">
        <div class="row admin_consultation_section">
          <div class="col-lg-12">
            ...
            <div class="optionbotton_section">
              <a href="contact_us" class="request_a_demo_botton">Get In Touch</a>
            </div>
          </div>
        </div>
        <br />
        ...
        <div class="row uiuxmain_banner">
          <img src="public/web/images/webdevelopmentHeroBanner.png" alt=""  width="100%"/>
        </div>
          ...
          <div class="col-lg-12">
            <center>
              ...
              <div class="app_design_position">
                <img src="public/web/images/webdevicons.png" alt="appicons"  width="100%"/>
              </div>
            </center>
          </div>
        </div>
          ...
          <div class="col-lg-4">
            <div class="card card_modification2">
              <div class="takecontrol_section">
                <img src="public/web/images/service1.png" alt="service1 image" />
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" >
              <div class="carousel-inner custom-display-slider">
                <div class="carousel-item active">
                  <img class="d-block" src="public/web/images/casestudyimage.png" alt="First slide"/>
                  <br />
                ...
                <div class="carousel-item">
                  <img class="d-block" src="public/web/images/casestudyimage2.png" alt="Second slide"/>
                  <br />
                  <div class="case_study_carousal_heading">
                    YaMarket stock app
                  </div>
                ...
                <div class="carousel-item">
                  <img class="d-block" src="public/web/images/casestudyimage.png" alt="Third slide" />
                  <br />
                  <div class="case_study_carousal_heading">
                    YaMarket stock app
                  </div>
